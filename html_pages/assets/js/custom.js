...
const textAnimations = [
  ...
  // },
  {
    elements: ".sustain-reports-desc h2, .sustain-reports-desc .sustain-reports-txt, .sustain-reports-desc a",
...
$(document).ready(function(){
  $('.detail-shopslider-thumbnails').slick({
    infinite: false,
    slidesToShow: 1,
    slidesToScroll: 1,
...
// jQuery(document).ready(function(){
//   var $head_container = jQuery('.pro-slider-top .container');
//   var head_margin = $head_container.css('padding-left'); 
...
jQuery(document).ready(function($){
  function applyResponsiveStyles() {
    if ($(window).width() <= 1024) {
      ...
      $(".listing-slider-wrap .owl-nav").css({"right": head_margin});
      $(".listing-slider-wrap").css({"padding-left": head_margin});
    } else {
      // Reset styles if needed
      var $head_container = $('.pro-slider-top .container');
      var head_padding = $head_container.css('padding-left'); 

      $(".listing-slider-wrap .owl-nav").css({"right": head_padding});
      $(".listing-slider-wrap").css({"padding-left": head_padding});
    }
  }
...
jQuery('.tab-cont-inn').owlCarousel({
    loop: true,
    margin: 20,
    // stagePadding: 70,
    dots: false,
...
jQuery('.detail-fea-inner').owlCarousel({
    loop: true,
    margin: 20,
    dots: false,
    nav: true,
