                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="region" id="input-status" class="form-control"> 
                                        ...
                                        <option value="Support" <?= $region == 'Support' ? ' selected="selected"' : ''; ?>>Support</option> 
                                        <option value="Document &amp; Printing Solutions" <?= $region == 'Document &amp; Printing Solutions' ? ' selected="selected"' : ''; ?>>Document & Printing Solutions</option>
                                        <option value="Categories" <?= $region == 'Categories' ? ' selected="selected"' : ''; ?>>Categories</option> 
                                        <option value="Plasmacluster Technology" <?= $region == 'Plasmacluster Technology' ? ' selected="selected"' : ''; ?>>Plasmacluster Technology</option> 
                                    </select>
                                </div>
                            </div> 
                        </div>
