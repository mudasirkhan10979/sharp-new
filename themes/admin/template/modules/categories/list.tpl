                                      ...
                                      <td class="text-left">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input status-toggle"
                                                        id="statusToggle<?php echo $sc_category['category_id']; ?>"
                                                        <?php echo ($sc_category['status']) ? 'checked' : ''; ?>
                                                        data-status-id="<?php echo $sc_category['category_id']; ?>">
                                                    <label class="custom-control-label"
                                                        for="statusToggle<?php echo $sc_category['category_id']; ?>">
...
<script>
    $(document).on('change', 'input[type="checkbox"]', function() {
        ...
        var CategoryId = checkbox.data('status-id');
        ...
        $.ajax({
            url: '<?php echo $ajaxupdatecategorystatus; ?>',
            method: 'POST',
            data,
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    rowData[2] =
                        ...
                        CategoryId + '" ' + (newStatus ? 'checked' : '') + ' data-status-id="' +
                        CategoryId + '"> <label class="custom-control-label" for="statusToggle' +
                        CategoryId + '">' + newStatusText + '</label> </div>';
