                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                     <button type="button" class="btn btn-danger btn-sm delete-image-btn"
                                        ...
                                        onclick="deleteCertificatesAndResearchImage('<?= $certificatesandresearch_id ?>')">
...
<script>
function deleteCertificatesAndResearchImage(certificatesandresearch_id) {
    if (confirm('Are you sure you want to delete this image?')) {
        fetch('<?php echo $deleteImage; ?>&certificatesandresearch_id=' + certificatesandresearch_id)
        .then(res => res.json())
        .then(data => {
            if (data.success) {
        ...
        .catch(err => {
            console.error('Error deleting Certificates and Research image:', err);
