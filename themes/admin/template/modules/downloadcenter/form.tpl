                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                            <div class="form-group required">
                                                <label class="control-label" for="input-download-description<?php echo $lang['language_id'] ?>">
                                                    Description
                                                </label>
                                                <textarea name="download_description[<?php echo $lang['language_id'] ?>][description]" placeholder="Description" id="input-download-description<?php echo $lang['language_id'] ?>" class="form-control"> <?php echo isset($download_description[$lang['language_id']]) ? $download_description[$lang['language_id']]['description'] : ''; ?></textarea>
...
<script type="text/javascript">
    <?php foreach ($languages as $lang) { ?>
        var lang = 'input-download-description<?php echo $lang['language_id'] ?>';
