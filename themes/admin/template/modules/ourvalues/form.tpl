                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="ourvalues_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($ourvalues_description[$lang['language_id']]) ? $ourvalues_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea
                                                name="ourvalues_description[<?php echo $lang['language_id'] ?>][short_description]"
                                                rows="5" placeholder="Description"
                                                id="input-short-description<?php echo $lang['language_id'] ?>"
                                                class="form-control"><?php echo isset($ourvalues_description[$lang['language_id']]) ? $ourvalues_description[$lang['language_id']]['short_description'] : ''; ?></textarea>
                        ...
                        <div class="tab-pane" id="tab-data">
                            <div class="row col-md-12">
                                    ...
                                    <label class="control-label" for="input-image">
                                      Image (1600 x 830px)
                                        ...
                                        <input onchange="loadFile(event)" type="file" name="image" id="image"
                                            accept=".png,.jpg,.jpeg,.svg" style="display: block;">
                                        <?php if ($error_image) { ?>
                                        <div class="text-danger">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                    <img id="bimage" src="../uploads/image/ourvalues/<?= $image ?>"
