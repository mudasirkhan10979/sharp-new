                        ...
                        <div class="card-bodys">
                            <table class="table table-striped table-bordered table-hover" id="sharp-table" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <thead>
                                    ...
                                    <th><input type="text" placeholder="On Page"></th>
            ...
            success: function(response) {
                ...
                if (response.success) {
                    if (response.success) {
                        ...
                        rowData[3] = '<div class="custom-control custom-switch"><input type="checkbox" class="custom-control-input status-toggle" id="statusToggle' + blockId + '" ' + (newStatus ? 'checked' : '') + ' data-status-id="' + blockId + '"> <label class="custom-control-label" for="statusToggle' + blockId + '"> ' + newStatusText + '</label> </div>';
