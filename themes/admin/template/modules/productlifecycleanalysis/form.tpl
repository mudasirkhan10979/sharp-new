                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                      <button type="button" class="btn btn-danger btn-sm delete-image-btn"
                                        ...
                                        onclick="deleteProductLifeCycleImage('<?= $productlife__id ?>')">
...
<script>
function deleteProductLifeCycleImage(productlife__id) {
    if (confirm('Are you sure you want to delete this image?')) {
        fetch('<?php echo $deleteImage; ?>&productlife__id=' + productlife__id)
        .then(res => res.json())
        .then(data => {
            if (data.success) {
        ...
        .catch(err => {
            console.error('Error deleting Product Life Cycle image:', err);
