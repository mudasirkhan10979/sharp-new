                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="ourteams_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($ourteams_description[$lang['language_id']]) ? $ourteams_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="ourteams_description[<?php echo $lang['language_id'] ?>][designation]"
                                                value="<?php echo isset($ourteams_description[$lang['language_id']]) ? $ourteams_description[$lang['language_id']]['designation'] : ''; ?>"
                                     ...
                                     <!-- <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea
                                                name="ourteams_description[<?php echo $lang['language_id'] ?>][short_description]"
                                                rows="5" placeholder="Description"
                                                id="input-short-description<?php echo $lang['language_id'] ?>"
                                                class="form-control"><?php echo isset($ourteams_description[$lang['language_id']]) ? $ourteams_description[$lang['language_id']]['short_description'] : ''; ?></textarea>
                        ...
                        <div class="tab-pane" id="tab-data">
                            <div class="row col-md-12">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($image) { ?>
                                    <img id="bimage" src="../uploads/image/ourteams/<?= $image ?>"
