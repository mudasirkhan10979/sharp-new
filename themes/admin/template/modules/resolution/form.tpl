                                ...
                                <div class="tab-pane" id="language<?php echo $lang['language_id'] ?>">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text"
                                                name="resolution_description[<?php echo $lang['language_id'] ?>][title]"
                                                value="<?php echo isset($resolution_description[$lang['language_id']]) ? $resolution_description[$lang['language_id']]['title'] : ''; ?>"
                                                placeholder="Title"
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <textarea
                                                name="resolution_description[<?php echo $lang['language_id'] ?>][description]"
                                                rows="5" placeholder="Description"
                                                id="input-description<?php echo $lang['language_id'] ?>"
                                                class="form-control"><?php echo isset($resolution_description[$lang['language_id']]) ? $resolution_description[$lang['language_id']]['description'] : ''; ?></textarea>
