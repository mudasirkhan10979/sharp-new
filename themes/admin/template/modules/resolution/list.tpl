                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input status-toggle"
                                                        id="statusToggle<?php echo $resolution['resolution_id']; ?>"
                                                        <?php echo ($resolution['status']) ? 'checked' : ''; ?>
                                                        data-status-id="<?php echo $resolution['resolution_id']; ?>">
                                                    <label class="custom-control-label"
                                                        for="statusToggle<?php echo $resolution['resolution_id']; ?>">
                                                        <?php echo ($resolution['status']) ? 'Active' : 'Inactive'; ?>
                                                    </label>
                                                </div>
                                            </td>
                                            <td class="text-right">
                                                ...
                                                <form style="display: inline-block;"
                                                    action="<?php echo $resolution['delete']; ?>" method="post"
                                                    enctype="multipart/form-data"
                                                    id="del_resolution<?php echo $resolution['resolution_id']; ?>">
                                                    ...
                                                    <button type="button" data-toggle="tooltip"
                                                        ...
                                                        onClick='submitDeleteForm("del_resolution<?php echo $resolution['resolution_id']; ?>")'><i
...
<script>
    $(document).on('change', 'input[type="checkbox"]', function() {
        ...
        var resolutionId = checkbox.data('status-id');
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    rowData[1] =
                        ...
                        resolutionId + '" ' + (newStatus ? 'checked' : '') + ' data-status-id="' +
                        resolutionId + '"> <label class="custom-control-label" for="statusToggle' +
                        resolutionId + '">' + newStatusText + '</label> </div>';
