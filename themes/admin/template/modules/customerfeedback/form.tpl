                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    <?php if ($icon) { ?>
                                     <button type="button" class="btn btn-danger btn-sm delete-image-btn"
                                        ...
                                        onclick="deleteCustomerImage('<?= $feedback_id ?>')">
                                    ...
                                    <?php } ?>
                                    <input type="hidden" id="hidden_image" name="icon" value="<?= $icon ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
...
<script>
function deleteCustomerImage(feedback_id) {
    if (confirm('Are you sure you want to delete this image?')) {
        fetch('<?php echo $deleteImage; ?>&feedback_id=' + feedback_id)
        .then(res => res.json())
        .then(data => {
            if (data.success) {
        ...
        .catch(err => {
            console.error('Error deleting customer feedback image:', err);
