                            ...
                            <div class="row" style="padding-right: 9px;padding-left: 9px;">
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <input onchange="loadFile(event)" type="file" name="image" id="image" accept=".png,.jpg,.jpeg,.svg" style="display: block;">
                                    </div>
                                    <?php if ($error_image) { ?>
                                        <div class="text-danger">
                                ...
                                <div class="col-lg-2 col-md-2 ">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm delete-image-btn"
                                        ...
                                        onclick="deleteLcareportImage('<?= $lcareport_id ?>')">
    ...
    var loadFile = function(event) {
        ...
        if (file) {
            ...
            if (validExtensions.indexOf(extension) === -1 || file.size > maxSize) {
                event.target.value = '';
                alert('Please select a valid file (PNG, JPEG, JPG, SVG) less than 1 MB.');
                return false;
            } else {
...
<script>
function deleteLcareportImage(lcareport_id) {
    if (confirm('Are you sure you want to delete this image?')) {
        fetch('<?php echo $deleteImage; ?>&lcareport_id=' + lcareport_id)
        .then(res => res.json())
        .then(data => {
            if (data.success) {
        ...
        .catch(err => {
            console.error('Error deleting Lcareport image:', err);
