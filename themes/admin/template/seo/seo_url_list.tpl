                ...
                <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="text-left"><?php if ($sort == 'query'): ?><a href="<?php echo $sort_query; ?>" class="{{ order|lower }}"><?php echo $column_query; ?></a><?php else: ?><a href="<?php echo $sort_query; ?>"><?php echo $column_query; ?></a><?php endif; ?></td>
                      <td class="text-left"><?php if ($sort == 'keyword'): ?><a href="<?php echo $sort_keyword; ?>" class="{{ order|lower }}"><?php echo $column_keyword; ?></a> <?php else: ?><a href="<?php echo $sort_keyword; ?>"><?php echo $column_keyword; ?></a><?php endif; ?></td>
                      <td class="text-left"><?php if ($sort == 'store'): ?><a href="<?php echo $sort_store; ?>" class="{{ order|lower }}"><?php echo $column_store; ?></a><?php else: ?><a href="<?php echo $sort_store; ?>"><?php echo $column_store; ?></a><?php endif; ?></td>
                      <td class="text-left"><?php if ($sort == 'language'): ?><a href="<?php echo $sort_language; ?>" class="{{ order|lower }}"><?php echo $column_language; ?></a><?php else: ?><a href="<?php echo $sort_language; ?>"><?php echo $column_language; ?></a><?php endif; ?></td>
