...
$('#button-search').on('click', function(e) {
	var url = '<?php echo $ajaxUrl; ?>filemanager&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>';
...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: '<?php echo $ajaxUrl; ?>filemanager/upload&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
				type: 'post',		
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: '<?php echo $ajaxUrl; ?>filemanager/folder&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',		
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: '<?php echo $ajaxUrl; ?>filemanager/delete&token=<?php echo $token; ?>',
			type: 'post',		
			dataType: 'json',
