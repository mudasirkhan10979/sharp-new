        ...
        <div class="menuright">
            <ul>
                <li title="Products">
                 ...
                 <?php if ($user->hasPermission('access', 'attribute')) : ?>
                    <li title="Attribute">
                ...
                <?php endif; ?>
                 ...
                 <?php if ($user->hasPermission('access', 'attributevalue')) : ?>
                    <li title="Attribute value">
                        <a href="<?php echo $attributevalue; ?>">
                            <i class="fa fa-desktop" aria-hidden="true"></i>
                            Attribute value
                        </a>
                    </li>
...
<?php endif; ?>
<?php if ($user->hasPermission('access', 'service_centers')) : ?>
    <li class="nav-item">
        <div class="nav-link" title="Service Centers">
            <a href="<?php echo $service_centers; ?>">
                <span class="icon-bg_drop">Service Centers</span>
                <i class="fa fa-truck menuIcon" aria-hidden="true"></i>
            </a>
        </div>
    </li>
<?php endif; ?>
...
<?php if ($user->hasPermission('access', 'newsletters')) : ?>
  <li class="nav-item">
        <div class="nav-link" title="Subscriptions">
            <a href="<?php echo $newsletters; ?>">
                <span class="icon-bg nodropdown">Subscriptions</span>
...
<?php if ($user->hasPermission('access', 'customerfeedback')) : ?>
  <li class="nav-item">
        <div class="nav-link" title="Customer Feedbacks">
            <a href="<?php echo $customerfeedback; ?>">
                <span class="icon-bg nodropdown">Customer Feedbacks</span>
