        ...
        <tr>
          <td>
              ...
              <tr>
                <td align="left" valign="bottom" style="padding: 50px 50px 40px 50px; background-color: #fff; vertical-align: middle;" width="100%">
                  <div class="div-col" style="display:inline-block; float: left; width: 50%;">
                    <p class="td-left" style="color: #144C60; font-family: Arial, sans-serif; font-size: 24px; font-style: normal; font-weight: 700;" float="left">Booking Payment Link</p>
                  </div>
                </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 30px 50px 30px; background-color: #fff;">
                  <h1 class="welcome" style="font-size: 24px; color: #144C60; font-family: Arial, sans-serif; font-weight: 700; margin-bottom: 16px;">Dear <?php echo $memberName; ?>,</h1>
                  <p class="middle-para" style="color: #144C60; font-family: Arial, sans-serif; font-size: 16px; line-height: 25px;"><?php echo $text_greeting; ?> </p>
                </td>
              </tr>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 30px 50px 30px; background-color: #fff;">
                  <h1 class="welcome" style="font-size: 20px; color: #144C60; font-family: Arial, sans-serif; font-weight: 700; margin-bottom: 16px;">Booking Details</h1>
                  <p class="middle-para" style="color: #144C60; font-family: Arial, sans-serif; font-size: 16px; line-height: 25px;">Please find the details of booking below</p>
                </td>
              </tr>
            </table>
            <div class="table-wrapper" style="padding: 0px 50px 60px; background-color: #fff;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto;" class="tbl-res">
                <thead>
                  <tr>
                    <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;">Booking Id</td>
                    <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;">Program Name</td>
                    <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: right; padding: 7px; color: #222222;">Total Quantity</td>
                    ...
                    <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: right; padding: 7px; color: #222222;">Total Amount</td>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <?php if ($program) { ?>
                    <tr>
                      <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $booking_id; ?></td>
                      <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $program['program_title']; ?>
                      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $program['quantity']; ?></td>
                      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $program['program_price']; ?> AED</td>
                      <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $total; ?> AED</td>
                    </tr>
                  <?php } ?>
                </tbody>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto;">
              <td style="padding: 0px 10px 90px 50px; background-color: #fff;" class="login-tem">
                
                <a class="login-btn" href="<?php echo $paymentLink; ?>" style="background-color: #D85636; border-radius: 7px; color: #fff; text-decoration: none; font-size: 15px;  font-family: Arial, sans-serif; font-weight: 700; padding: 14px 36px; max-width: 215px; border: 1px solid #D85636;  display: inline-block;">Pay Now</a>
              </td>
