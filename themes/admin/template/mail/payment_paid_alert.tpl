...
<head>
  ...
  <title>Booking Payment Recieved</title>
  <style>
              ...
              <tr>
                <td align="left" valign="bottom" style="padding: 50px 50px 40px 50px; background-color: #fff; vertical-align: middle;" width="100%">
                  <div class="div-col" style="display:inline-block; float: left; width: 50%;">
                    <p class="td-left" style="color: #144C60; font-family: Arial, sans-serif; font-size: 24px; font-style: normal; font-weight: 700;" float="left">Booking Confirmed</p>
                  </div>
                  <div class="div-col" style="display:inline-block; float: right; width: 50%;">
                    <p class="td-right" style="color: #144C60; text-align: center; font-family: Arial; font-size: 15px; font-style: normal; font-weight: 400; text-align: right;" float="right">Booking No: <b><?php echo $order_id; ?></b></p>
                  </div>
                </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 30px 50px 30px; background-color: #fff;">
                  <h1 class="welcome" style="font-size: 24px; color: #144C60; font-family: Arial, sans-serif; font-weight: 700; margin-bottom: 16px;">Dear Admin,</h1>
                  <p class="middle-para" style="color: #144C60; font-family: Arial, sans-serif; font-size: 16px; line-height: 25px;">The payment for the booking id : <?php echo $order_id ; ?> has been received. The booking has been processed and confirmed.</p>
                </td>
              </tr>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 30px 50px 30px; background-color: #fff;">
                  ...
                  <p class="middle-para" style="color: #144C60; font-family: Arial, sans-serif; font-size: 16px; line-height: 25px;">Please find the details of paid booking below</p>
                </td>
              </tr>
            </table>
            <div class="table-wrapper" style="padding: 0px 50px 60px; background-color: #fff;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto;" class="tbl-res">
                ...
                <tbody>
                    ...
                    <tr>
                      <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $order_id; ?></td>
                      <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $program['title']; ?>
