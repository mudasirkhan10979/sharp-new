        ...
        var o = "simpleSocialShare",
            ...
            r = {
                init: function (e, t) {
                    var n = this;
                    return (
                        (n.options = $.extend(!0, {}, $.fn[o].options, e)),
                        (n.namespace = "." + o + "." + new Date().getTime()),
                        (n.element = t),
                        (n.$element = $(t)),
                        (n.allowedNetworks = ["facebook", "twitter", "linkedin", "googleplus", "pinterest", "reddit", "instagram"]),
                        n.bind(),
                        n
                    );
                },
                ...
                openSocialSharePopup: function (e) {
                    ...
                    var t = this,
                        ...
                        p = "";
                    if (("undefined" != typeof o && "undefined" != typeof i && t.allowedNetworks.indexOf(i) > -1 && (n = !0), n === !0))
                        switch (i) {
                            case "facebook":
                            ...
                            case "googleplus":
                                ...
                                break;
                            case "linkedin":
                                (p = "https://www.linkedin.com/shareArticle?mini=true&url=" + encodeURIComponent(o) + "&source=" + encodeURIComponent(o)),
                                    "undefined" != typeof a && "" !== a && (p += "&title=" + encodeURIComponent(a)),
                                    "undefined" != typeof r && "" !== r && (p += "&summary=" + encodeURIComponent(r));
                                break;
                            case "pinterest":
                                (p = "https://www.pinterest.com/pin/create/button/?url=" + encodeURIComponent(o)),
                                    "undefined" != typeof s && "" !== s && (p += "&media=" + encodeURIComponent(s)),
                                    "undefined" != typeof r && "" !== r && (p += "&description=" + encodeURIComponent(r)),
                                    "undefined" != typeof c && "" !== c && (p += "&hashtags=" + c);
                                break;
                            case "reddit":
                                p = "http://www.reddit.com/submit/?url=" + encodeURIComponent(o);
                                break;
                            case "twitter":
                                (p = "https://twitter.com/intent/tweet?&url=" + encodeURIComponent(o)),
                                    "undefined" != typeof r && "" !== r && (p += "&text=" + encodeURIComponent(r)),
                                    "undefined" != typeof d && "" !== d && (p += "&via=" + encodeURIComponent(d)),
                                    "undefined" != typeof c && "" !== c && (p += "&hashtags=" + c);
                                break;
                            default:
                                return !1;
