...
<div id="smooth-wrapper">
    <div id="smooth-content">
        <div class="main-container">
            ...
            <?php endif; ?>
            <section>
                <div class="pages-tab-menu user-manual-tab">
                    <div class="container">
                        <div class="p-tab-menu-inn">
                            <ul>
                                ...
                                <li class="active"><a
                                        href="<?php echo HTTP_HOST; ?>source-code-download"><?php echo $text_user_manual; ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section>
                <div class="download-center-listing">
                    <div class="container">
                        <div class="d-center-listing-inn u-menual-listing-inn">
                            <div class="container">
                                ...
                                <div class="d-center-listing">
                                    <div class="download-center-list-inn" id="manuals-container">
                                        <?php if (!empty($usermanuals)) { ?>
                                        <?php foreach ($usermanuals as $manual): ?>
                                        <div class="u-menual-item">
                                            <div class="u-menual-item-inn">
                                                <div class="u-menual-item-img">
                                                    <img src="<?php echo BASE_URL; ?>themes/sharp/assets/imgs/pdf-icon.svg"
                                                        alt="">
                                                </div>
                                                <h3><?php echo $manual['title']; ?></h3>
                                                <!-- <p><?php echo date('Y-m-d', strtotime($manual['publish_date'])); ?></p> -->
                                                <div class="um-item-link">
                                                    <a class="btn-default" target="_blank"
                                                        href="<?php echo BASE_URL . 'uploads/image/user_manuals/' . $manual['file']; ?>">Download
                                                        <span><img
                                                                src="<?php echo BASE_URL; ?>themes/sharp/assets/imgs/arrow.svg"
                                                                alt=""></span></a>
                                                </div>
            ...
            $(document).ready(function() {
                ...
                function performSearch() {
                    ...
                    $.ajax({
                        url: '<?php echo HTTPS_HOST; ?>usermanuals/search',
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        success: function(response) {
                            $('#manuals-container').html(response.html);
                            if (response.pagination) {
                                $('#pagination-container').html('<div class="pagination-default">' +
                            ...
                            var newUrl = '<?php echo HTTP_HOST; ?>user-manuals' + (params
